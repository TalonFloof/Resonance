...
public class Constants {
	...
	public static final TagKey<Biome> IS_FOREST = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_forest"));
	...
	public static final TagKey<Biome> IS_DESERT = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_desert"));
	public static boolean isDesert(Holder<Biome> b) { return b.is(IS_DESERT) || b.is(Biomes.DESERT); }
	public static final TagKey<Biome> IS_JUNGLE = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_jungle"));
	public static boolean isJungle(Holder<Biome> b) { return b.is(IS_JUNGLE) || b.is(BiomeTags.IS_JUNGLE); }
	public static final TagKey<Biome> IS_SAVANNA = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_savanna"));
	public static boolean isSavanna(Holder<Biome> b) { return b.is(IS_SAVANNA) || b.is(BiomeTags.IS_SAVANNA); }
	public static final TagKey<Biome> IS_TAIGA = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_taiga"));
	public static boolean isTaiga(Holder<Biome> b) { return b.is(IS_TAIGA) || b.is(BiomeTags.IS_TAIGA); }
	public static final TagKey<Biome> IS_BEACH = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_beach"));
	public static boolean isBeach(Holder<Biome> b) { return b.is(IS_BEACH) || b.is(BiomeTags.IS_BEACH) || b.is(Biomes.STONY_SHORE); }
	public static final TagKey<Biome> IS_OCEAN = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_ocean"));
	public static boolean isOcean(Holder<Biome> b) { return b.is(IS_OCEAN) || b.is(BiomeTags.IS_OCEAN) || b.is(BiomeTags.IS_DEEP_OCEAN); }
	public static final TagKey<Biome> IS_RIVER = TagKey.create(Registries.BIOME,ResourceLocation.parse("c:is_river"));
